                ...
                <div class="filters mt-3">
                  <div class="form-check form-check-inline">
                    <input
                      ...
                      checked=""
                    />
                    <label class="form-check-label" for="facultyFilter"
                      >Faculty</label
                    >
                  </div>
                  <div class="form-check form-check-inline">
                    <input
                      ...
                      checked=""
                    />
                    <label class="form-check-label" for="staffFilter"
                      >Staff</label
                    >
                  </div>
                  <div class="form-check form-check-inline">
                    <input
                      ...
                      checked=""
                    />
                    <label class="form-check-label" for="researchFilter"
                      >Research</label
                    >
                  </div>
                  <div class="form-check form-check-inline">
                    <input
                      ...
                      checked=""
                    />
                    <label class="form-check-label" for="adminFilter"
                ...
                <ul class="nav nav-tabs flex-column">
                  ...
                  <li class="nav-item">
                    <button
                      class="nav-link"
                      data-bs-toggle="tab"
                      data-bs-target="#faculty--staff-tab-3"
                    >
                      Physics
                    </button>
                  </li>
                  <li class="nav-item">
                    <button
                      class="nav-link"
                      data-bs-toggle="tab"
                      data-bs-target="#faculty--staff-tab-4"
                    >
                      Biology
                    </button>
                  </li>
                  <li class="nav-item">
                    <button
                      class="nav-link"
                      data-bs-toggle="tab"
                      data-bs-target="#faculty--staff-tab-5"
                    >
                      Chemistry
                    </button>
                  </li>
              ...
              <div class="tab-content">
                ...
                >
                  <div class="department-info mb-4">
                    ...
                    <p>
                      ...
                      Mauris dapibus, eros vel vestibulum laoreet, lacus mi
                      efficitur velit, id pharetra odio magna nec augue.
                    </p>
                  </div>
                  <div class="row g-4">
                      ...
                      <div class="faculty-card">
                        ...
                        <div class="faculty-info">
                          ...
                          <div class="faculty-contact">
                            <a href="mailto:jbaker@example.com"
                    ...
                    <div class="col-md-6 col-lg-4">
                      <div class="faculty-card">
                        ...
                        <div class="faculty-info">
                          ...
                          <div class="faculty-contact">
                            <a href="mailto:swilson@example.com"
                              ><i class="bi bi-envelope"></i> Email</a
                            >
                            <a href="#" class="profile-link"
                              ><i class="bi bi-person"></i> Profile</a
                    ...
                    <div class="col-md-6 col-lg-4">
                      <div class="faculty-card">
                        ...
                        <div class="faculty-info">
                          ...
                          <div class="faculty-contact">
                            <a href="mailto:mchen@example.com"
                              ><i class="bi bi-envelope"></i> Email</a
                            >
                            <a href="#" class="profile-link"
                              ><i class="bi bi-person"></i> Profile</a
                    ...
                    <div class="col-md-6 col-lg-4">
                      <div class="faculty-card">
                        ...
                        <div class="faculty-info">
                          ...
                          <div class="faculty-contact">
                            <a href="mailto:erodriguez@example.com"
                              ><i class="bi bi-envelope"></i> Email</a
                            >
                            <a href="#" class="profile-link"
                              ><i class="bi bi-person"></i> Profile</a
                    ...
                    <div class="col-md-6 col-lg-4">
                      <div class="faculty-card">
                        ...
                        <div class="faculty-info">
                          ...
                          <div class="faculty-contact">
                            <a href="mailto:rwilliams@example.com"
                              ><i class="bi bi-envelope"></i> Email</a
                            >
                            <a href="#" class="profile-link"
                              ><i class="bi bi-person"></i> Profile</a
                    ...
                    <div class="col-md-6 col-lg-4">
                      <div class="faculty-card">
                        ...
                        <div class="faculty-info">
                          ...
                          <div class="faculty-contact">
                            <a href="mailto:adavis@example.com"
                              ><i class="bi bi-envelope"></i> Email</a
                            >
                            <a href="#" class="profile-link"
                              ><i class="bi bi-person"></i> Profile</a
                ...
                <div class="tab-pane fade" id="faculty--staff-tab-2">
                  <div class="department-info mb-4">
                    ...
                    <p>
                      Curabitur a felis in nunc fringilla tristique. Fusce
                      egestas elit eget lorem. Etiam vitae tortor. Nam at tortor
                    ...
                    <div class="col-md-6 col-lg-4">
                      <div class="faculty-card">
                        ...
                        <div class="faculty-info">
                          ...
                          <div class="faculty-contact">
                            <a href="mailto:plee@example.com"
                              ><i class="bi bi-envelope"></i> Email</a
                            >
                            <a href="#" class="profile-link"
                              ><i class="bi bi-person"></i> Profile</a
                    ...
                    <div class="col-md-6 col-lg-4">
                      <div class="faculty-card">
                        ...
                        <div class="faculty-info">
                          ...
                          <div class="faculty-contact">
                            <a href="mailto:tgrant@example.com"
                              ><i class="bi bi-envelope"></i> Email</a
                            >
                            <a href="#" class="profile-link"
                              ><i class="bi bi-person"></i> Profile</a
                    ...
                    <div class="col-md-6 col-lg-4">
                      <div class="faculty-card">
                        ...
                        <div class="faculty-info">
                          ...
                          <div class="faculty-contact">
                            <a href="mailto:narmstrong@example.com"
                              ><i class="bi bi-envelope"></i> Email</a
                            >
                            <a href="#" class="profile-link"
                              ><i class="bi bi-person"></i> Profile</a
                ...
                <div class="tab-pane fade" id="faculty--staff-tab-4">
                  <div class="department-info mb-4">
                    ...
                    <p>
                      Vivamus elementum semper nisi. Sed fringilla mauris sit
                      amet nibh. In auctor lobortis lacus. Suspendisse non nisl
                      sit amet velit hendrerit rutrum.
                    </p>
                  </div>
                  <div class="row g-4">
                    <div class="col-md-6 col-lg-4">
                      <div class="faculty-card">
                        ...
                        <div class="faculty-info">
                          ...
                          <div class="faculty-contact">
                            <a href="mailto:lwong@example.com"
                              ><i class="bi bi-envelope"></i> Email</a
                            >
                            <a href="#" class="profile-link"
                              ><i class="bi bi-person"></i> Profile</a
                ...
                <div class="tab-pane fade" id="faculty--staff-tab-5">
                  <div class="department-info mb-4">
                    ...
                    <p>
                      Proin viverra, ligula sit amet ultrices semper, ligula
                      arcu tristique sapien, a accumsan nisi mauris ac eros.
                      Fusce neque. Suspendisse faucibus.
                    </p>
                  </div>
                  <div class="row g-4">
                    <div class="col-md-6 col-lg-4">
                      <div class="faculty-card">
                        ...
                        <div class="faculty-info">
                          ...
                          <div class="faculty-contact">
                            <a href="mailto:dsmith@example.com"
                              ><i class="bi bi-envelope"></i> Email</a
                            >
                            <a href="#" class="profile-link"
                              ><i class="bi bi-person"></i> Profile</a
