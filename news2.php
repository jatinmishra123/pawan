...
<head>
    ...
    <title>Repeat Sentence Practice - NiceSchool</title>
    <meta name="description" content="Practice English pronunciation by repeating sentences with our AI-powered tool" />
    <meta name="keywords" content="repeat sentence, english pronunciation, practice, AI speech, pte practice" />
...
<body class="contact-page">
                        ...
                        <ul class="d-flex list-unstyled mb-0 align-items-center">
                            <li class="nav-item dropdown me-3">
                                ...
                                <ul class="dropdown-menu border-0 shadow-lg rounded-3 p-2"
                                    aria-labelledby="ptePracticeLink">
                                    <li><a class="dropdown-item" href="news">Read Aloud <span class="badge bg-danger">AI
                                                Score</span></a>
                                    </li>
                                    <li><a class="dropdown-item" href="news2">Repeat Sentence <span
                                                class="badge bg-danger">AI
                                                Score</span></a></li>
                                    <li><a class="dropdown-item" href="#">Describe Image <span
                                                class="badge bg-danger">AI Score</span></a>
                                    </li>
                                </ul>
                            </li>
    ...
    <main class="main">
        <div class="page-title dark-background" style="background-color: rgba(87, 197, 214, 0.1)">
            <div class="container position-relative mb-5">
                <h1 class="text-info">Repeat Sentence Practice</h1>
                <p class="text-info">
                    Improve your English pronunciation with our AI-powered sentence repetition tool.
                </p>
                <nav class="breadcrumbs">
                    <ol>
                        <li><a href="alumni">Home</a></li>
                        <li class="current text-info">Repeat Sentence Practice</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="sd-card" role="region" aria-label="Stage Goal tip"
                                ...
                                <div class="d-flex align-items-center width">
                                    <div class="sd-icon me-3" aria-hidden="true">
                                        <svg fill="none" width="28" height="28" viewBox="0 0 28 28"
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <button type="button" class="btn btn-sm btn-outline-danger sd-cta"
                                            id="askStageBtn">Ask Now</button>
                                        <button type="button" class="btn p-0 sd-close" aria-label="Close tip"
                                            id="closeTipBtn">
                        ...
                        <div class="col-md-12 mt-5">
                            <div class="row">
                                ...
                                <div class="col-sm-11">
                                    <div class="sd-1">
                                        <h4 class="sd-title1"><b>Repeat Sentence
                                            </b><button type="button" class="btn btn-sm btn-info text-light"
                                                id="studyGuideBtn"><i class="bi bi-mortarboard"
                                                    style="margin-right:10px;"></i>Study Guide</button></h4>
                                        <p class="sd-desc1 mb-0">You will hear a sentence. Please repeat the sentence
            ...
            <section id="tts" class="tts-section" style="background-color:#FAFAFA;">
                <div class="container" data-aos="fade-up">
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <p class="mb-4">Practice Your Pronunciation
                            </p>
                        </div>
                        <div class="col-md-6">
                            <button type="button" class="btn btn-info btn-sm text-light float-end"
                                data-bs-toggle="modal" data-bs-target="#examInfoModal">
                                Tested(<span id="testedCount">0</span>)
                            </button>
                        </div>
                        <div class="col-md-12">
                            <p class="timer" id="timer">Time: 00:15</p>

                            <div class="text-display-area mb-3" id="textDisplay">
                                Select a sentence from the right panel to begin practice.
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="multi-btn">
                                        ...
                                        <div class="input-group"
                                            style="width:300px; display:inline-flex; vertical-align:middle;">
                                        ...
                                        <button class="btn btn-outline-secondary ms-2" id="prevBtn"
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="discussion-tab" data-bs-toggle="tab"
                                        data-bs-target="#discussion" type="button" role="tab">Discussion</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="me-tab" data-bs-toggle="tab" data-bs-target="#me"
                                        type="button" role="tab">Me</button>
                                </li>
                            </ul>
                    ...
                    <form id="examInfoForm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="examtype" id="pteaukvi"
                                    value="PTEA/UKVI" required>
                                <label class="form-check-label" for="pteaukvi">PTEA / UKVI</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="examtype" id="ptecore"
                                    value="PTE Core">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="testSelectorModalLabel">
                        <i class="bi bi-card-text me-2"></i>Repeat Sentence
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                        ...
                        <div class="d-flex flex-wrap gap-3 align-items-center">
                            ...
                            <div class="search-box ms-auto">
                                <div class="input-group input-group-sm" style="width: 200px;">
                                    ...
                                    <input type="text" class="form-control border-start-0 mb-9"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            let timeLeft = 15; // Adjusted timer for repeating sentences
            ...
            const dummyQuestions = {
                "338": "Parent teacher  are a great opportunity for open communication.",
                "1445": "Diapers are essential for infant hygiene and care.",
                ...
                "1441": "Blood pressure is the force of blood pushing against the walls of the arteries.",
                "1440": "The solar system consists of our Sun, eight planets, and countless other celestial objects.",
                "1439": "Global warming refers to the long-term rise in Earth's average temperature."
            };
            ...
            function init() {
                ...
                loadTestedCount();
                loadPracticeHistory();
                showSMS("Welcome to Repeat Sentence Practice", "info");
            ...
            // MODIFIED: This function now handles the new "Repeat Sentence" flow.
            applyTestBtn.addEventListener("click", function () {
                if (selectedQuestion) {
                    currentQuestionId = selectedQuestion.id;
                    getQuestionText(currentQuestionId)
                        .then((data) => {
                            currentText = data.text; // Store the text but don't display it
                            resetPracticeState();
                            playSentenceAndEnableRecording(currentText); // Play audio and then enable recording
                    ...
                    showSMS("Please select a sentence first.", "warning");
                }
            });

            // NEW: Function to play the sentence using AI voice and enable recording on completion.
            function playSentenceAndEnableRecording(text) {
                if (!text) {
                    showSMS("No text available to speak.", "warning");
                    return;
                }
                ...
                utterance.onstart = () => {
                    textDisplay.innerHTML = `<h4>Listening... <i class="bi bi-earbuds"></i></h4>`;
                    recordBtn.disabled = true;
                    showSMS("Listen to the sentence carefully.", "info");
                };

                utterance.onend = () => {
                    textDisplay.innerHTML = `<h4>Your turn! Click the mic and speak.</h4>`;
                    recordBtn.disabled = false;
                    showSMS("Now, repeat the sentence.", "success");
                };

                utterance.onerror = (e) => {
                    console.error("Speech synthesis error:", e);
                    showSMS("Could not play the audio. Please try again.", "error");
                    textDisplay.innerHTML = `Audio error. Please try again.`;
                    recordBtn.disabled = true;
                };
            ...
            function startTimer() {
                timeLeft = 15; // Set timer to 15 seconds for repeat sentence
            ...
            // --- Scoring and Feedback (No changes needed here) ---
            ...
            function calculateContentScore(expected, actual) {
                ...
                if (actualWords.length === 0 || actual === '') return 0;
                let matchedWords = 0;
                const tempActual = [...actualWords];
                for (let i = 0; i < expectedWords.length; i++) {
                    const index = tempActual.indexOf(expectedWords[i]);
                    if (index !== -1) {
                        matchedWords++;
                        tempActual.splice(index, 1);
                    }
                }
                return (matchedWords / expectedLength) * 30;
            }
            ...
            function calculatePronunciationScore(expected, actual) {
                ...
                return (correctlyPronouncedWords / expectedWords.length) * 30;
            }
            ...
            function calculateFluencyScore(expected, actual, timeTaken) {
                ...
                if (actualWordCount === 0 || timeTaken === 0) return 0;
                const wpm = expectedWordCount / (timeTaken / 60);
                let speedFactor = 0.5;
                if (wpm >= 200 && wpm <= 280) speedFactor = 1;
                else if (wpm > 180 && wpm < 200) speedFactor = 0.8;
                ...
                const resultsHTML = `
                                ...
                                <div class="container mt-3">
                                    <div class="card shadow-sm rounded-3">
                                        <div class="card-header bg-info text-white"><h5 class="mb-0">Score Breakdown</h5></div>
                                        <div class="card-body">
                                            <div class="row text-center">
                                                <div class="col-md-4 mb-3">
                                                    <div class="p-3 border rounded bg-light">
                                                        <h6 class="text-muted">Content</h6>
                                                        <p class="fs-5 fw-bold text-dark mb-0">${scoreResult.contentScore}/90</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <div class="p-3 border rounded bg-light">
                                                        <h6 class="text-muted">Pronunciation</h6>
                                                        <p class="fs-5 fw-bold text-dark mb-0">${scoreResult.pronunciationScore}/90</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <div class="p-3 border rounded bg-light">
                                                        <h6 class="text-muted">Fluency</h6>
                                                        <p class="fs-5 fw-bold text-dark mb-0">${scoreResult.fluencyScore}/90</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="feedback-area">
                                    ...
                                    <div class="text-center"><audio controls src="${audioUrl}"></audio></div>
                                    <hr>
                                    <p class="text-center fw-bold">Word-by-word analysis:</p>
                                    <p><strong>Original:</strong> ${generateFeedbackWords(currentText, userSpeech)}</p>
                                    ...
                                    <div class="speed-score">Speaking speed: ${wpm} words per minute</div>
            ...
            function getOverallFeedback(score) {
                if (score >= 80) return '<p class="correct">Excellent! Your repetition was highly accurate.</p>';
                if (score >= 60) return '<p class="correct">Good job! Your speech is mostly accurate with good fluency.</p>';
                if (score >= 40) return "<p>Not bad! With more practice, you'll improve your accuracy.</p>";
                return '<p class="incorrect">Keep practicing! Focus on listening carefully and repeating exactly what you hear.</p>';
            }
            ...
            function generateFeedbackWords(expected, actual) {
                ...
                expectedWords.forEach(word => {
                    ...
                    if (actualWords.includes(cleanWord)) {
                        resultHtml += `<span class="correct-word">${word} </span>`;
                    } else {
                        resultHtml += `<span class="incorrect-word">${word} </span>`;
                    }
                });
                resultHtml += '</div>';
                return resultHtml;
            ...
            function getSpeedFeedback(wpm) {
                if (wpm >= 200 && wpm <= 180) return '<p class="correct speed-feedback">Your speaking speed is perfect!</p>';
                if (wpm > 280) return '<p class="incorrect speed-feedback">Your speech is a bit too fast.</p>';
                if (wpm < 100) return '<p class="incorrect speed-feedback">Your speech is a bit too slow.</p>';
                return '';
            }
            ...
            function setupEventListeners() {
                ...
                document.getElementById("submitBtn").addEventListener("click", () => {
                    ...
                    setTimeout(() => handleSubmission(submitBtn), 1500); // Simulate processing delay
                });
            ...
            function handleRedo() {
                if (currentText) {
                    resetPracticeState();
                    playSentenceAndEnableRecording(currentText);
                    showSMS("Practice restarted. Listen carefully!", "info");
                } else {
                    showSMS("No sentence selected to redo.", "warning");
                }
            }
