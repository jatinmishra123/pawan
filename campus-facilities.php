            ...
            <div class="row align-items-center">
              <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                <div class="intro-content">
                  ...
                  <p class="lead">
                    Discover state-of-the-art facilities designed to inspire
                    learning and growth
                  </p>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Proin scelerisque magna vitae eros faucibus, vitae finibus
                    massa pharetra. Nullam egestas dolor in condimentum
                    faucibus.
                  </p>
              ...
              <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                <div class="intro-image-container">
                  <div class="intro-image main-image">
                    <img
                      src="assets/img/education/campus-1.webp"
                      alt="Main Campus"
                  ...
                  <div class="intro-image accent-image">
                    <img
                      src="assets/img/education/campus-2.webp"
                      alt="Campus Feature"
                      class="img-fluid rounded"
                    />
                  </div>
                  <div class="tour-button">
                    <a href="#" class="btn-tour"
                      ><i class="bi bi-play-circle-fill"></i> Virtual Tour</a
                    >
                  </div>
                </div>
              </div>
                    ...
                    <div class="facility-highlight">
                      <div class="facility-slider">
                        <div class="facility-slide">
                          <img
                            src="assets/img/education/campus-3.webp"
                            alt="Library"
                            class="img-fluid rounded"
                          />
                      ...
                      <div class="facility-description">
                        ...
                        <p>
                          ...
                          elit. Nam gravida luctus urna, vel efficitur purus
                          faucibus vitae. Sed interdum ligula eu metus tempor
                          dapibus.
                        </p>
                        <ul class="feature-list">
                          ...
                          <li>
                            <i class="bi bi-check-circle-fill"></i> Specialized
                  ...
                  >
                    <div class="facility-cards">
                      <div class="facility-card">
                        ...
                        <p>
                          Lorem ipsum dolor sit amet, consectetur adipiscing
                          elit. Maecenas vestibulum ante vel magna convallis.
                        </p>
                        <span class="info-badge"
                          ><i class="bi bi-info-circle"></i> 24 Labs</span
                        >
                      </div>
                      ...
                      <div class="facility-card">
                        ...
                        <span class="info-badge"
                          ><i class="bi bi-info-circle"></i> 42 Facilities</span
                        >
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="facility-highlight">
                      ...
                      <div class="facility-description">
                        ...
                        <ul class="feature-list">
                          ...
                          <li>
                            <i class="bi bi-check-circle-fill"></i> Professional
                            running track
                          </li>
                          <li>
                            <i class="bi bi-check-circle-fill"></i> Fitness and
                            training centers
                          </li>
                        </ul>
                      </div>
                  ...
                  >
                    <div class="facility-cards">
                      <div class="facility-card">
                        ...
                        <span class="info-badge"
                          ><i class="bi bi-info-circle"></i> Olympic
                          Standard</span
                        >
                      </div>
                      ...
                      <div class="facility-card">
                        ...
                        <span class="info-badge"
                          ><i class="bi bi-info-circle"></i> Pro Equipment</span
                        >
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="facility-highlight">
                      ...
                      <div class="facility-description">
                        ...
                        <ul class="feature-list">
                          ...
                          <li>
                            <i class="bi bi-check-circle-fill"></i> Suite-style
                            accommodations
                          </li>
                          <li>
                            <i class="bi bi-check-circle-fill"></i> Community
                            lounges and kitchens
                          </li>
                          <li>
                            <i class="bi bi-check-circle-fill"></i> 24/7
                  ...
                  >
                    <div class="facility-cards">
                      <div class="facility-card">
                        ...
                        <span class="info-badge"
                          ><i class="bi bi-info-circle"></i> 5 Locations</span
                        >
                      </div>
                      ...
                      <div class="facility-card">
                        ...
                        <span class="info-badge"
                          ><i class="bi bi-info-circle"></i> 24/7 Support</span
                        >
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div class="facility-highlight">
                      ...
                      <div class="facility-description">
                        ...
                        <ul class="feature-list">
                          <li>
                            <i class="bi bi-check-circle-fill"></i> Student
                            activity center
                          </li>
                          <li>
                            <i class="bi bi-check-circle-fill"></i> Art
                            galleries and theaters
                          </li>
                          <li>
                            <i class="bi bi-check-circle-fill"></i> Green spaces
                            and gardens
                          </li>
                          <li>
                            <i class="bi bi-check-circle-fill"></i> Meeting and
                            event venues
                          </li>
                        </ul>
                      </div>
                  ...
                  >
                    <div class="facility-cards">
                      <div class="facility-card">
                        ...
                        <span class="info-badge"
                          ><i class="bi bi-info-circle"></i> 3 Venues</span
                        >
                      </div>
                      ...
                      <div class="facility-card">
                        ...
                        <span class="info-badge"
                          ><i class="bi bi-info-circle"></i> 8 Locations</span
                        >
                      </div>
                    </div>
                  </div>
          ...
          >
            <div class="gallery-grid">
              ...
              <div class="gallery-item" data-aos="zoom-in" data-aos-delay="300">
                <img
                  src="assets/img/education/campus-9.webp"
                  alt="Dormitory"
                  class="img-fluid"
                  loading="lazy"
                />
              ...
              <div class="gallery-item" data-aos="zoom-in" data-aos-delay="400">
                <img
                  src="assets/img/education/campus-10.webp"
                  alt="Study Areas"
                  class="img-fluid"
                  loading="lazy"
                />
              ...
              <div class="col-lg-5" data-aos="fade-right" data-aos-delay="100">
                <div class="map-info">
                  ...
                  <p>
                    ...
                    interactive map. Locate buildings, facilities, and services
                  ...
                  <a href="#" class="btn-map"
                    ><i class="bi bi-download"></i> Download PDF Map</a
                  >
                </div>
              </div>
